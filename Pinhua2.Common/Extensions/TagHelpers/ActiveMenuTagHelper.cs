...
namespace TagHelpers
{
    ...
    public class ActivePageTagHelper : TagHelper
    {
        ...
        private bool ShouldBeActive()
        {
            ...
            var keywords = currentPage.Split("/");
            var keyword = keywords.Length > 1 ? keywords[1] : "Root";
            if (!string.IsNullOrWhiteSpace(Page) && Page.ToLower() != keyword.ToLower())
            {
                return false;
            }
