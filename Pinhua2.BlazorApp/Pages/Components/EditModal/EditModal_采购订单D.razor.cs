...
{
    public partial class EditModal_采购订单D : ComponentBase
    {
        [Parameter] public EventCallback<EditModal_采购订单D> OnOK { get; set; }
        [Parameter] public EventCallback<EditModal_采购订单D> OnCancel { get; set; }

        protected KModal modal;
        protected string[] dropdownItems => new[] { "片", "平方米", "延长米", "立方米", "套" };

        protected dto采购订单D currentDataSource
        {
            get
            {
                return DataSource;
        ...
        [Parameter] public dto采购订单D DataSource { get; set; }
