...
{
    public partial class EditModal_销售报价D : ComponentBase
    {
        [Parameter] public EventCallback<EditModal_销售报价D> OnOK { get; set; }
        [Parameter] public EventCallback<EditModal_销售报价D> OnCancel { get; set; }
