...
{
    public partial class Modal_商品列表_采购订单 : ComponentBase
    {
        protected KModal modal;
        protected KTable2 table;
        protected List<dto采购订单D> products;

        [Inject] IMapper Mapper { get; set; }
        [Inject] Pinhua2Context PinhuaContext { get; set; }

        [Parameter] public EventCallback<Modal_商品列表_采购订单> OnOK { get; set; }
        [Parameter] public EventCallback<Modal_商品列表_采购订单> OnCancel { get; set; }
