...
namespace Pinhua2.Web.BlazorComponents.CheckBox
{
    public partial class BCheckBoxGroup<TValue> : Blazui.Component.Form.BFieldComponentBase<IEnumerable<TValue>>
    {
        [Parameter]
